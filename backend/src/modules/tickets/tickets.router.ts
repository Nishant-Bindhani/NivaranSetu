...
import {
  ...
  countMyTicketsHandler,
  getTicketByIdHandler,
  listCategoriesHandler,
} from './tickets.controller.js'
import { validate, validateQuery } from '@middleware/validate.middleware.js'
import { requireAuth } from '@middleware/authenticate.middleware.js'
import { createTicketSchema, listTicketsQuerySchema, countTicketsQuerySchema } from './tickets.validation.js'
...
router.get('/count', validateQuery(countTicketsQuerySchema), countMyTicketsHandler)
