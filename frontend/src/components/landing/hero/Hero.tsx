...
import { AppMockup } from '@/components/landing/appMockup/AppMockup'
import { DotGrid } from '@/components/landing/shared/bgpatterns/DotGrid'
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 md:grid-cols-2">
        <div className="text-center md:text-left">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground md:mx-0">
            Lodge your complaint online, through WhatsApp, or by email. Track the status
            of your grievance at every stage, from submission to verified resolution.
          </p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row md:justify-start">
            <Button size="lg" nativeButton={false} render={<Link to="/register">Lodge a Complaint</Link>} />
            <Button size="lg" variant="outline" nativeButton={false} render={<Link to="/track">Track Complaint Status</Link>} />
          </div>
        </div>
