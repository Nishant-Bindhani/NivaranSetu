...
- **Authorization (RBAC)**: Citizen, Officer, Manager, Admin, each inheriting the tier below
...
- **GIS & Maps**: GPS-tagged filing, reverse geocoding, officer location tracking, department heatmaps
